...
saveit = lambda obj, fn: cq.exporters.export(obj, save_to(fn), opt=dict(ascii=True))

things = ("crystal", "reflector", "pad", "optical_readout")
...
meta = {
    ...
    "pad": generate_meta(
        ...
        trans=(
            0,
            0,
            (pad_loc := -crystal_dims[2] / 2 - sipms.optical_pad_thickness / 2),
        ),
    ),
